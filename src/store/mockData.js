...
const sevenSecretsArticles = [
    {
        ...
        content: `Hi, this is Steve Kaufmann Founder of LingQ and I'm going to speak to you about the Seven Secrets to Successful Language Learning.
...
If you're going to make any progress in language learning, spend time with the language. So that's secret No. 1 and I will continue on to the other six secrets. There are a total of seven secrets to successful language learning. Thank you for listening.`,
    ...
    {
        id: 2,
        title: "2 – Do What You Like to Do",
        language: "English",
        level: "Beginner",
        courseId: COURSE_ID,
        courseTitle: COURSE_TITLE,
        content: `Hi, this is Steve Kaufmann again talking about the Seven Secrets to Successful Language Learning.
...
In language learning do what you like to do, but continue doing it.`,
    ...
    {
        id: 3,
        title: "3 – Learn to Notice",
        language: "English",
        level: "Beginner",
        courseId: COURSE_ID,
        courseTitle: COURSE_TITLE,
        content: `Hi, there, it's Steve Kaufmann Founder of LingQ and I'm going to talk to you about the third of my Secrets to Successful Language Learning.
...
Thank you.`,
    ...
    {
        id: 4,
        title: "4 – Words Over Grammar",
        language: "English",
        level: "Beginner",
        courseId: COURSE_ID,
        courseTitle: COURSE_TITLE,
        content: `Hi there, this is Steve Kaufmann Founder of LingQ continuing my series of Seven Secrets to Successful Language Learning.
...
4, focus on words and the rest of it will fall into place. Thank you for listening.`,
    ...
    },
    {
        ...
        courseId: COURSE_ID,
        courseTitle: COURSE_TITLE,
        content: `Hi, there, this is Steve Kaufmann Founder of LingQ and today I'm gonna talk about the fifth Secret to Successful Language Learning.
...
Thank you for listening.`,
    ...
    {
        id: 6,
        title: "6 – Get the Tools",
        language: "English",
        level: "Beginner",
        courseId: COURSE_ID,
        courseTitle: COURSE_TITLE,
        content: `Hi, there, this is Steve Kaufmann Founder LingQ continuing in my series of Seven Secrets to Successful Language Learning.
...
Thank you for listening and we've got one more secret to go.`,
    ...
    {
        id: 7,
        title: "7 – Become an Independent Language Learner",
        language: "English",
        level: "Beginner",
        courseId: COURSE_ID,
        courseTitle: COURSE_TITLE,
        content: `Hi there, Steve Kaufmann here again with the seventh in my series of Secrets to Successful Language Learning.
...
export const mockVocabulary = {
    // Empty by default - users will add their own words
};
